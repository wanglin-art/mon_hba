...
@Service("mmp_adgroupService")
public class Mmp_adgroupServiceImpl implements Mmp_adgroupService {
    int count = 0;
    @Resource
    ...
    public void getData() {
        ...
        FindIterable<Document> documents = mongoTemplate.getCollection("mmp_adgroup").find();
